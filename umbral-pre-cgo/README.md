...
[![Version](https://img.shields.io/badge/version-v0.11.3--go-blue.svg)](https://github.com/vlsilver/umbral/releases)

Go bindings for the Umbral Proxy Re-encryption library with Ethereum key support.

**Version**: v0.11.3-go (based on umbral-pre v0.11.0)
