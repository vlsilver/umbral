...
powershell -Command "& {Invoke-WebRequest -Uri 'https://github.com/vlsilver/umbral/releases/download/v0.11.0-go/libumbral_pre.dll' -OutFile 'lib\libumbral_pre.dll'}"
